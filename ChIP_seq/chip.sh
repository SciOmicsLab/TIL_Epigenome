...
#Setting root folder
ROOT_FOLDER="${PWD}"
FASTQ_FOLDER_Group1="${PWD}/group_1_fastq"
FASTQ_FOLDER_Group2="${PWD}/group_2_fastq"
INDEX_FILE="${PWD}/../genome/GRCh38_noalt_as"
...
mkdir -p ${ROOT_FOLDER}/trimmed_group1
for f in $(ls $FASTQ_FOLDER_Group1/*.gz); do
...
mkdir -p ${ROOT_FOLDER}/aligned_group1
mkdir -p ${ROOT_FOLDER}/aligned_group1_stats
echo $ROOT_FOLDER
...
#Aligning group 2
mkdir -p ${ROOT_FOLDER}/aligned_group2
mkdir -p ${ROOT_FOLDER}/aligned_group2_stats
echo $ROOT_FOLDER
...
mkdir -p ${ROOT_FOLDER}/raw_line_counts_group1
for f in $(ls ${ROOT_FOLDER}/aligned_group1/*.sam); do
echo $f
bam_file="${f/$ROOT_FOLDER/}"
echo $bam_file
...
mkdir -p ${ROOT_FOLDER}/sorted_group1
...
mkdir -p ${ROOT_FOLDER}/filtered_group1
for f in $(ls ${ROOT_FOLDER}/sorted_group1/*.bam); do
echo $f
bam_file="${f/$ROOT_FOLDER/}"
echo $bam_file
...
mkdir -p ${ROOT_FOLDER}/dedup_group1
...
#Final line count 
mkdir -p ${ROOT_FOLDER}/final_line_counts_group1
for f in $(ls ${ROOT_FOLDER}/dedup_group1/*.bam); do
echo $f
bam_file="${f/$ROOT_FOLDER/}"
echo $bam_file
...
#Calling peaks 
mkdir -p ${ROOT_FOLDER}/peaks_group1
...
#The bam reads must be cleaned before peak calling
#First check line counts
mkdir -p ${ROOT_FOLDER}/raw_line_counts_group2
...
#First sort the bam files with samtools
mkdir -p ${ROOT_FOLDER}/sorted_group2
for f in $(ls ${ROOT_FOLDER}/aligned_group2/*.bam); do
echo $f
bam_file2="${f/$ROOT_FOLDER/}"
echo $bam_file2
...
#Removing multimapping reads
mkdir -p ${ROOT_FOLDER}/filtered_group2
for f in $(ls ${ROOT_FOLDER}/sorted_group2/*.bam); do
echo $f
bam_file2="${f/$ROOT_FOLDER/}"
echo $bam_file2
...
mkdir -p ${ROOT_FOLDER}/dedup_group2
...
Final line count 
mkdir -p ${ROOT_FOLDER}/final_line_counts_group2
for f in $(ls ${ROOT_FOLDER}/dedup_group2/*.bam); do
echo $f
bam_file2="${f/$ROOT_FOLDER/}"
echo $bam_file2
...
#Calling peaks 
mkdir -p ${ROOT_FOLDER}/peaks_group2
